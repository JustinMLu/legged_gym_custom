...
from deploy_base.base_controller import BaseController, ConfigParser
...
class RobotController(BaseController):
    ...
    def move_to_default_pos(self):
        ...
        print("Interpolation time: ", move_time)
...
if __name__ == "__main__":
    ...
    parser.add_argument("net", type=str, help="Specify the network interface ('eth0', 'eno1', etc.)", default="eno1")
    parser.add_argument("config", type=str, help="config file name in the configs folder", default="go2.yaml")
    args = parser.parse_args()

    # Load config from path
    file_path = f"{LEGGED_GYM_ROOT_DIR}/deploy/unified_configs/{args.config_file}"
